...
"GameMenu"
{
	...
	"Custom1"
	{
		"label"			"command1"					//THIS IS THE TEXT FOR THE BUTTON, THE BUTTONS ARE SMALL SO KEEP THAT IN MIND
	...
	"Custom2"
	{
		"label"			"command2"					//THIS IS THE TEXT FOR THE BUTTON, THE BUTTONS ARE SMALL SO KEEP THAT IN MIND
	...
	"Custom3"
	{
		"label"			"command3"					//THIS IS THE TEXT FOR THE BUTTON, THE BUTTONS ARE SMALL SO KEEP THAT IN MIND
	...
	"Custom4"
	{
		"label"			"command4"					//THIS IS THE TEXT FOR THE BUTTON, THE BUTTONS ARE SMALL SO KEEP THAT IN MIND
	...
	{
		"label"			"<"
		"command"		"engine con_enable 1;showconsole;echo ;echo ;echo ***************************************;echo * ------------ EveHUD ------------- *;echo * ------ A HUD made by Vera ------ *;echo * ------- https://steamcommunity.com/id/starvera/ ------- *;echo ***************************************;echo ;echo ***************************************;echo * ------- Based on PeachHUD and SunsetHUD -------- *;echo * ---------- By Peach & Hypnotize ----------- *;echo * ------ Github.com/Hypnootize ------ *;echo ***************************************;echo ;echo ***************************************;echo * --------- HUD Crosshairs ---------- *;echo * ---------- By Hypnotize ----------- *;echo * ------ Github.com/Hypnootize ------ *;echo ***************************************;echo ;echo ***************************************;echo * ------ Material Design VTFs ------- *;echo * ---- By extracrispy and Rawsor ---- *;echo * -- Probably somewhere on the web -- *;echo ***************************************;echo ;echo ***************************************;echo * --------- Menu Background --------- *;echo * ----- GMK Fuyu Deskmat Render ----- *;echo * --------- Link on Github ---------- *;echo ***************************************;echo ;echo ***************************************;echo ;echo ;"
		"tooltip"		"HUD Credits"
		"OnlyAtMenu"	"1"
	}
